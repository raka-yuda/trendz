...
const options: ApexOptions = {
  ...
  // colors: ['#10B981', '#375E83', '#259AE6', '#FFA70B', '#FFA700', '#FFA7AA'],
...
const SentimentChart = ({series, labels, data, topic, handleChangeTopic, optionsTopic, topicValue}: ChartThreeState) => {
