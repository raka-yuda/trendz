...
const ScrapeRequestTable = ({
  ...
  const handleStatusChange = (event) => {
    ...
    const currentStatusValue = event.target.value;
    handleFilter({
  ...
  return (
    <React.Fragment>
      ...
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-col py-6 px-4 md:px-6 xl:px-7.5">
          <div className="flex justify-between items-center">
            ...
            <div
              ...
              className={`absolute top-36 right-10 mt-24 z-10 flex w-62.5 flex-col rounded-sm border border-stroke bg-white shadow-xl dark:border-strokedark dark:bg-boxdark ${
            ...
            >
              {/* <ul className="flex flex-col gap-5 border-b border-stroke px-6 py-7.5 dark:border-strokedark">
                <li>
                  <button 
                    className="w-[22] h-[22] flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base"
                    onClick={handleShowAddModal}
                    // () => setIsAddModalVisible(true)
                  >
                    <FaPlus />
          ...
          <div className="flex flex-row mt-4">
            ...
            <div className="relative z-1 bg-transparent dark:bg-form-input">
              ...
              /> */}
              <select 
                className="w-full relative z-9 appearance-none rounded border border-stroke bg-transparent py-3 pl-5 pr-10 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary text-sm font-medium"
              ...
              <span className="absolute top-1/2 right-4 z-[8] -translate-y-1/2">
                <svg
                  className="fill-current"
                  width="24"
                  height="24"
            ...
            <button 
              className="flex items-center justify-center rounded bg-primary p-3 text-gray mx-4 gap-2 text-sm font-medium"
              type="button"
              onClick={handleReset}
        ...
        <div className="flex justify-between py-4 mr-4">
          ...
          <div className="grid grid-cols-5 gap-1 items-center rounded-md bg-whiter p-1.5 dark:bg-meta-4">
            ...
            <button
              ...
              className={`rounded py-1 px-3 text-base font-medium text-black hover:bg-white hover:shadow-card dark:text-white dark:hover:bg-boxdark ${
                (currentPage == lastPage && currentPage != 1) ? 'bg-white shadow-card dark:bg-boxdark' : ''
              }`}
            >
              {(lastPage == 1 ? '-' : lastPage) ?? '-'}
            </button>
